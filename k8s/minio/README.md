MINIO gives you the ability to provision block storage.  It is compatible with S3 api.

This chart will provision you by default 2 buckets, bucket 1 and bucket 2.

Once deployed, to access the minio GUI use port forward.

For example

kubectl port-forward platform-minio-57f74988b9-2gzq5 9000:9000 -n minio &
